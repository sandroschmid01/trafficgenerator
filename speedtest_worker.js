...
var settings = {
	...
	time_dl_max: 3600, // max duration of download test in seconds
	...
	xhr_dlUseBlob: true, // iif set to true, it reduces ram usage but uses the hard drive (useful with large garbagePhp_chunkSize and/or high xhr_dlMultistream)
